...
Original file is located at
    https://colab.research.google.com/drive/1901oV47XkJavgPxP6WVM0D2eSF-930q2
"""
...
uploaded_file = st.sidebar.file_uploader(
    "Unggah Rekaman CCTV / Video Udara",
    type=["mp4", "avi", "mov"]
)
...
if uploaded_file is not None:
    ...
    st.info("💡 **Petunjuk:** Silakan unggah file rekaman video CCTV Anda pada panel samping kiri untuk memulai kalkulasi inferensi model OBB.")
